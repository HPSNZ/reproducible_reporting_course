...
# Note: We're using the "ToothGrowth" data set, one of many data sets that
# are included when you install base R. As a built-in data set, it is already
# ready to be used in an R session - no need to explicitly import it!
...
- It's **powerful** because it allows you to make changes to almost anything that comprises a data plot. If you can imagine it, there will likely be a way to make it with `{ggplot2}`.

--

- It's **flexible** because it covers a lot of common plot types. It's also been designed for *extensibility*, so other developers have created extension packages to supplement the plotting capabilities of `{ggplot2}`.

--

- Because it is **widely used**, there are tons of helpful resources online, including books, tutorials, video walkthroughs, and presentations. It is also a popular topic for R workshops, if you want to engage with an in-person / guided learning experience.
]
