...
We will use functions from these packages: `{dplyr}`, `{tidyr}`, `{janitor}`, `{stringr}`.
...
What happens if we try to calculate the `sum()` of values in the variable `len` (from the `ToothGrowth` data set)?
