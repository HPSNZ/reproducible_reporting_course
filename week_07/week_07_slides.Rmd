...
Let's import data from SQL into R.

Read through the code below - can you identify the SQL object that is being imported? What information might be stored in this SQL object? 
...
audience_data <- sqlQuery(
  con,
  "SELECT * FROM [CME_HPSNZ].[survey].[vw_audience_p2p]")
